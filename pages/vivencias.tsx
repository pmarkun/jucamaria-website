...
export default function VivenciasPage({ residencias }: VivenciasPageProps) {
  return (
    <Layout
      title="Residências"
      description="Conheça o formato de residência artística da Juca Maria: tempo longo de imersão em território, produção coletiva e presença no mundo."
    >
      {/* Header */}
        ...
        <div className="max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              ...
              <ul className="text-sm text-[#555] flex flex-col gap-1.5">
      ...
      <section className="py-20 text-center bg-[#2B2B2B]">
        <div className="max-w-xl mx-auto px-6">
          ...
          <p className="text-[#D8D3CA] mb-8">
            Entre em contato para saber das próximas chamadas abertas.
          </p>
          <Link
            href="/contato"
